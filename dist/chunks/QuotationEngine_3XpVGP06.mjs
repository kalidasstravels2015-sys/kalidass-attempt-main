...
import 'web-vitals';
import { u as useLanguage, s as siteContent } from './Layout_D-d8fNH6.mjs';
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
              /* @__PURE__ */ jsx("label", { htmlFor: `${stableFormId}-passengers`, className: "block text-xs font-bold text-slate-600 uppercase mb-1.5", children: isTa ? "பயணிகள்" : "Passengers" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
              /* @__PURE__ */ jsx("label", { htmlFor: `${stableFormId}-vehicle`, className: "block text-xs font-bold text-slate-600 uppercase mb-1.5", children: isTa ? "வாகனம்" : "Vehicle" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus-within:ring-2 focus-within:ring-indigo-500/20", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative group col-span-2 md:col-span-1", children: [
              /* @__PURE__ */ jsx("label", { htmlFor: `${stableFormId}-name`, className: "block text-xs font-bold text-slate-600 uppercase mb-1.5", children: isTa ? "பெயர்" : "Name" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative group col-span-2 md:col-span-1", children: [
              /* @__PURE__ */ jsx("label", { htmlFor: `${stableFormId}-phone`, className: "block text-xs font-bold text-slate-600 uppercase mb-1.5", children: isTa ? "தொலைபேசி" : "Phone" }),
            ...
            activeTab === "round" && /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
              /* @__PURE__ */ jsx("label", { htmlFor: `${stableFormId}-days`, className: "block text-xs font-bold text-slate-600 uppercase mb-1.5", children: isTa ? "நாட்கள்" : "Days" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus-within:ring-2 focus-within:ring-indigo-500/20", children: [
